...
function langVerification(){
    ...
    switch (index) {
        ...
        case 2:
            ...
            break;
        case 3:
            textSelect(["devtools-descricao","portifolio-descricao",'sounifyme-descricao',"infoeduc-descricao","work-title","work-aviso","virtualdeck-descricao"],textLangs[idioma].work)
            break;
        case 4:
